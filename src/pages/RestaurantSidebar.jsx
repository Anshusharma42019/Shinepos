...
import { FiHome, FiGrid, FiUsers, FiCreditCard, FiClipboard, FiPackage, FiShoppingBag, FiTag, FiStar, FiTarget, FiList, FiPlus, FiSettings, FiLogOut, FiChevronDown, FiMenu, FiX, FiBarChart, FiClock, FiCpu, FiTruck, FiFileText, FiTrendingUp, FiPieChart, FiDownload, FiUserCheck, FiCoffee } from 'react-icons/fi';
...
const RestaurantSidebar = ({ activeTab, setActiveTab, onLogout, sidebarOpen, setSidebarOpen }) => {
  ...
  const reportsSubItems = [
    { id: 'reports', label: 'All Reports', icon: <FiFileText /> }
  ];
          ...
          <div className="p-6 border-b border-white/20">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                <div className="text-4xl text-gray-900"><FiCoffee /></div>
                <div>
